...
const Home = () => {
  ...
  return (
    <Animate play start={{ opacity: 0 }} end={{ opacity: 1 }}>
      <div
        className={`overflow-x-hidden min-h-screen transition-colors duration-500 ${
          darkMode
            ? "bg-primary-900 text-neutral-100"
            : "bg-neutral-50 text-primary-900"
        }`}
      >
        {/* Header Section */}
        <header
        ...
        >
          <div className="flex items-center justify-between px-8 sm:px-20 py-5 max-w-7xl mx-auto">
            <h1
              className={`text-2xl sm:text-3xl font-bold tracking-tight scale-in ${
        ...
        <section className="relative flex flex-col items-center justify-center text-center min-h-screen pt-24 px-8 overflow-hidden">
          <div className="max-w-6xl mx-auto z-10">
            <div className="space-y-8">
              <div>
                {/* Badge */}
                <span
                  className={`fade-in-up inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${
                    darkMode
              ...
              {/* Subheading */}
              <p
                className={`text-lg sm:text-xl lg:text-2xl max-w-3xl mx-auto font-light leading-relaxed fade-in-up ${
              ...
              >
                ...
                user interfaces and love crafting{" "}
                <span
                  className={`font-semibold ${
                    darkMode ? "text-white" : "text-primary-900"
                  }`}
              ...
              <div className="flex flex-wrap gap-3 justify-center pt-8 max-w-2xl mx-auto fade-in-up">
                {["React", "TailwindCSS", "JavaScript", "Node.js", "UI/UX", "Figma"].map(
                  (tech, index) => (
                    <span
                      key={tech}
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
            {/* Gradient Orbs */}
            <div
              className={`absolute top-1/4 -right-48 w-96 h-96 rounded-full blur-3xl pulse ${
                darkMode ? "bg-accent-900/20" : "bg-accent-200/40"
              }`}
            ></div>
            <div
              className={`absolute bottom-1/4 -left-48 w-96 h-96 rounded-full blur-3xl pulse ${
                darkMode ? "bg-primary-700/20" : "bg-primary-200/40"
              }`}
              style={{ animationDelay: "2s" }}
            ></div>
            <div
              className={`absolute top-1/2 left-1/2 w-72 h-72 rounded-full blur-3xl pulse ${
            ...
            {/* Floating Elements */}
            <div
              className={`absolute top-32 right-32 w-20 h-20 rounded-lg rotate-12 float ${
                darkMode
                  ? "bg-gradient-to-br from-accent-600/20 to-accent-800/20 border border-accent-700/30"
                  : "bg-gradient-to-br from-accent-100 to-accent-200 border border-accent-300"
              }`}
            ></div>
            <div
              className={`absolute bottom-40 left-20 w-16 h-16 rounded-full float ${
                darkMode
                  ? "bg-gradient-to-br from-primary-600/20 to-primary-800/20"
                  : "bg-gradient-to-br from-primary-100 to-primary-200"
              }`}
              style={{ animationDelay: "1.5s" }}
            ></div>
            <div
              className={`absolute top-1/2 right-1/4 w-12 h-12 rounded-lg -rotate-45 float ${
                darkMode
                  ? "bg-accent-700/20 border border-accent-600/30"
        ...
        >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="scroll-reveal space-y-6">
                ...
                >
                  ...
                  specializing in ReactJS, TailwindCSS, and creating engaging
                  user interfaces.
                </p>
                <p
                  className={`text-lg leading-relaxed ${
                ...
                >
                  With a knack for detail and performance, I aim to deliver
                  high-quality projects tailored to the user's needs. Every
          ...
          {/* Decorative Elements */}
          <div
            className={`absolute top-20 right-20 w-32 h-32 rounded-full blur-3xl opacity-20 ${
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="scroll-reveal text-center mb-16">
              ...
              >
                A selection of my recent work showcasing design and development
                expertise
              </p>
            </div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <div className="scroll-reveal">
              ...
              <p
                className={`mb-12 text-lg sm:text-xl leading-relaxed max-w-2xl mx-auto ${
                  darkMode ? "text-neutral-300" : "text-neutral-600"
                }`}
              >
        ...
        {/* Footer */}
        <footer
          className={`relative text-center py-12 border-t ${
            darkMode
              ? "bg-primary-900 border-neutral-800"
        ...
        >
          <div className="max-w-6xl mx-auto px-8">
            ...
            >
              ...
              >
                &copy; {new Date().getFullYear()} Mostafa.MA. Crafted with
